...
namespace App.API.Controllers
{
    ...
    public class RolePermissionsController : ControllerBase
    {
        ...
        public RolePermissionsController(CRMDevContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != rolePermission.PermissionCode)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<RolePermission>> PostRolePermission(RolePermission rolePermission)
        {
            ...
            {
                if (RolePermissionExists(rolePermission.PermissionCode))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetRolePermission", new { id = rolePermission.PermissionCode }, rolePermission);
        }
        ...
        {
            return _context.RolePermissions.Any(e => e.PermissionCode == id);
        }
    }
}
